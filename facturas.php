<?php 
require_once 'php_action2/db_connect.php'; 
require_once 'includes/header.php'; 

if($_GET['o'] == 'addfact') { 
	echo "<div class='div-request div-hide'>addfact</div>";
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="success-messages"></div> <!--/success-messages-->
  		...
  		<form class="form-horizontal" method="POST" action="php_action2/createFactMas.php" id="createFactForm">

			  <div class="form-group">
			    <label for="facturasDate" class="col-sm-2 cntrol-label">Fecha</label>
			    <div class="col-sm-10">
			   <input type="text" class="form-control" id="facturasDate" name="facturasDate" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    <label for="clientLastName" class="col-sm-2 control-label">Apellido</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientLastName" name="clientLastName" placeholder="Apellidos del cliente" autocomplete="off"  />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Añadir fila</button>
			      ...
			      <button type="submit" id="createFactBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i>Guardar</button>
		...
		<?php } else if($_GET['o'] == 'manfact') { 
			...
			<table class="table" id="manageFactTable">
				<thead>
					<tr>
						<th>#</th>
						<th>Fecha</th>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action2/editFact.php" id="editFactForm">

  			<?php $facturasId = $_GET['i'];
			  ...
			  <div class="form-group">
			    <label for="facturasDate" class="col-sm-2 control-label">Fecha</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="facturasDate" name="facturasDate" autocomplete="off" value="<?php echo $data[1] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Nombre</label>
			  ...
			  <div class="form-group">
			    <label for="clientLastName" class="col-sm-2 control-label">Apellidos</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientLastName" name="clientLastName" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$factItemSql = "SELECT facturas_item.facturas_item_id, facturas_item.facturas_id, facturas_item.product_id, facturas_item.quantity, facturas_item.rate, facturas_item.total FROM facturas_item WHERE facturas_item.facturas_id = {$facturasId}";
						$factItemResult = $connect->query($factItemSql);
						
			  		$arrayNumber = 0;
			  		$x = 1;
			  		while($orderItemData = $factItemResult->fetch_array()) {  ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					<div class="form-group">
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <input type="hidden" name="facturasId" id="facturasId" value="<?php echo $_GET['i']; ?>" />
...
<script src="custom/js/facturas.js"></script>
